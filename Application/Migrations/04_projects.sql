...
(
  ...
  ticket_type enum_ticket_type NOT NULL,
  ticket_state enum_ticket_state NOT NULL,
  CONSTRAINT tbl_project_worker_group_pk 
      PRIMARY KEY (project_id, worker_group_id,
...
(
  ...
  CONSTRAINT tbl_project_worker_group_filter_pk 
      PRIMARY KEY (id, project_id, worker_group_id, 
      ticket_type, ticket_state, property_key),
