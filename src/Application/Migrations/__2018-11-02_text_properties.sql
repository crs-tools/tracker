...
ALTER TABLE tbl_encoding_profile_property ALTER COLUMN "value" SET DATA TYPE text;
ALTER TABLE tbl_project_property ALTER COLUMN "value" SET DATA TYPE text;
ALTER TABLE tbl_ticket_property ALTER COLUMN "value" SET DATA TYPE text;
...
DO language plpgsql $$
BEGIN
        RAISE WARNING 'DO NOT FORGET: it is very likely that you have to give GRANT on the recreated view_serviceable_tickets, view_parent_tickes and view_all_tickets to your tracker DB user after executing this script!';
END
$$;
